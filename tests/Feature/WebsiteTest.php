...
final class WebsiteTest extends TestCase
{
    ...
    public function testHomePageRendersCalculatorAndAdSlots(): void
    {
        ...
        self::assertStringContainsString('UK salary after tax calculator for 2026/27 take-home pay.', $html);
        ...
        self::assertStringContainsString('<title>UK Salary After Tax Calculator 2026/27 | Take-Home Pay | No Cap Tools</title>', $html);
        self::assertStringContainsString('UK salary after tax calculator for 2026/27 take-home pay.', $html);
    ...
    public function testGuidesPageShowsFormulasAndStepByStepWalkthrough(): void
    {
        ...
        self::assertStringContainsString('<title>UK Salary After Tax Guides 2026/27 | No Cap Tools</title>', $html);
